...
\item Write out the singular value decomposition theorem of a $3\times 1$, a $3\times 2$, and a $3\times 3$ symmetric matrix. Make it so that none of the components of your matrices are zero but your computations are simple. Explain why you choose the matrices you choose. 
